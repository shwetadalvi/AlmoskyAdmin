...
public interface ApiConstants {
    ...
    String allDriverListUrl = "admindriver/list/admin";
    String edtDriver = "driver/edit";
    String deleteDriver = "driver/delete";
    ...
    String notifyDriver = "order/cancel/notify";
    String resendOrder = "order/resend";
    String code = "code";
