...
public class SimpleArrayListAdapter extends ArrayAdapter<String> implements Filterable, ISpinnerSelectedView {
    ...
    public SimpleArrayListAdapter(Context context, List<Customer> strings,ArrayList<String> mBackupStrings) {
        super(context, R.layout.view_list_item);
        mContext = context;
        mStrings = strings;
        mBackupStrings = mBackupStrings;
    }
    ...
    public String getItem(int position) {
        if (mStrings != null && position > 0)
            return mStrings.get(position - 1).getFullName();
        else
            return null;
    }
