...
import admin.com.almoskyadmin.viewholder.IroningRecyclerViewHolders;
...
public class IroningRecyclerViewAdapter extends RecyclerView.Adapter<IroningRecyclerViewHolders> {
    ...
    public IroningRecyclerViewAdapter(Context context, ArrayList<data.Result> data, OrderDetailsActivity activity) {
