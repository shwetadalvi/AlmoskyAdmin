...
import admin.com.almoskyadmin.adapter.OutForDeliveryListAdapter;
 ...
 */
public class OutForDeliveryFragments extends Fragment implements HomeActivity.FragmentOutForDeliveryResultInterface{
    AppPrefes appPrefes;
    ApiCalls apiCalls;
    SimpleArcDialog dialog;
    HomeActivity tabHostActivity;
    RecyclerView rvOrders;
    OutForDeliveryFragments frag;
    private boolean isVisible;
    private boolean isStarted;
    private static final String ARG_PAGE_NUMBER = "page_number";

    public OutForDeliveryFragments() {
  ...
  /*  public static CompletedOrdersFragments newInstance(int page) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       tabHostActivity.setOutOfDeliveryListener(this);
     //  tabHostActivity.setCompletedListener(this);
       frag=new OutForDeliveryFragments();
    ...
    private void getOrders() {
        ...
        apiCalls.callApiPost(tabHostActivity, params, dialog, url, 7);


    }

    @Override
    public void fragmentoutofdeliveryResultInterface(String response, int requestId) {
        try{
           // Toast.makeText(getActivity(),"completed",Toast.LENGTH_LONG).show();
            ...
            OutForDeliveryListAdapter mAdapter = new OutForDeliveryListAdapter(tabHostActivity, orderList.getResult(),frag);
