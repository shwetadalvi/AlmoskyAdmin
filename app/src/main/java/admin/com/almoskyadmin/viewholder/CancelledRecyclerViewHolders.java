...
public class CancelledRecyclerViewHolders extends RecyclerView.ViewHolder {
    ...
    public CancelledRecyclerViewHolders(final View itemView, Context context, CancelledOrdersFragment fragments, HomeActivity activity) {
        super(itemView);
        ctx = context;
        _fragment = fragments;
        _activity = activity;
