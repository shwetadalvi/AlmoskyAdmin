...
public class CollectedRecyclerViewHolders extends RecyclerView.ViewHolder {
    ...
    public CollectedRecyclerViewHolders(final View itemView, Context context, CollectedFragments fragments, HomeActivity activity) {
        super(itemView);
        ctx = context;
        _fragment = fragments;
        _activity = activity;
        ...
        lyt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                _activity.updateOrder(data.getOrderID(), "collected");
            }
        });
